(function discordio(Discord){
	...
	DCP.getAudioContext = function(channelObj, callback) {
		...
		var voiceVolume = (typeof(channelObj) === 'object' && typeof(channelObj.voiceVolume) === 'number') ? channelObj.voiceVolume : 1.0;
		...
		voiceSession.audio = voiceSession.audio || new AudioCB(voiceSession, opusEncoder, audioChannels, voiceVolume);
	...
	function AudioCB(voiceSession, opusEncoder, audioChannels, voiceVolume) {
		EE.call(this);
		[
			["_port", null],
			["_sequence", 0],
